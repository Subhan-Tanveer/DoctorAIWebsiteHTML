...
def predict():
    if request.method == 'POST':
        ...
        desc, prec , work , medi , diet = helper(predicted_disease)
        ...
        return render_template("index.html", predicted_disease=predicted_disease, disease_desc=desc, disease_prec=my_prec, disease_work=work, disease_medi=my_medi, disease_diet=my_diet)
